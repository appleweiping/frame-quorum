...
| [CSV `load-scenes`](https://github.com/Breakthrough/PySceneDetect/blob/24953b0bf76af17c450bc143d330eea48fc5e276/scenedetect/_cli/controller.py#L160-L201): bypass detection and feed loaded cuts to later outputs | Strict bounded one-based `Start Frame` CSV import composed into exact-CFR video-only FCPXML, without detector statistics; see [contract](native-load-fcpxml.md) | `Start Timecode`/alternate columns, VFR mapping, reference sorting/postprocessing and general chained outputs remain open |
